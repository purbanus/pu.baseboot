...
/**
 * TextAreaOutputStream is an OutputStream with a TextArea attached, where all the
...
/**
 * Creates a new TextAreaOutputStream and attaches it to the specified TextArea.
 */
public TextAreaOutputStream( TextArea aTextArea )
{
	super();
	textArea = aTextArea;
...
/**
 * Returns the TextArea that sits at the end of the OutputStream.
 */
